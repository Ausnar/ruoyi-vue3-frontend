...
.conversation-scroll {
  ...
  overflow-y: auto;
  padding: 14px;
  background: var(--glass-scroll-bg);
}
...
.avatar {
  ...
  flex-shrink: 0;
  color: #fff;
  box-shadow: 0 8px 20px rgba(31, 45, 61, 0.15);
}
...
.user .message-text {
  background:
    linear-gradient(135deg, var(--color-primary), #287fe8 58%, #1f73dc);
  color: #fff;
  border-top-right-radius: 8px;
  box-shadow: 0 16px 32px rgba(38, 121, 220, 0.2);
}
